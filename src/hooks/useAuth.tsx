...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
        // Use onAuthStateChange as the SOLE auth initializer.
                // It fires INITIAL_SESSION automatically, replacing getSession().
                // This avoids the Web Locks race condition that caused
